...
UPDATE public.clientes SET nombre='John Doe' WHERE id=1;
...
UPDATE public.pedidos SET cliente_id=2 WHERE id=1;
...
UPDATE public.productos SET nombre='Pantalón' WHERE id=1;
...
"DetallesPedido". */
UPDATE public.DetallesPedido SET producto_id=2 WHERE pedido_id=1;
...
SELECT c.id id_cliente, nombre,p.id id_pedido  FROM public.clientes c
...
datos a entero. */
ALTER TABLE public.clientes
ALTER COLUMN telefono TYPE INT USING TO_NUMBER(telefono, '999999999');
